...
// =====================================================================================
                                ...
                                // IMPORTANTE
// SWITCHMAP es para para trabajar con un oberver que a su vez generar otro observer
// para que a su salida final solo me muestre lo que me muestra el observer final
// =====================================================================================
...
(() =>{
    ...
    getRequest(`${SW_API}/people/1`).pipe(
        ...
        // zip es para juntar en un arreglo el resultado de varios observers
    //     hago una destructuracion para que se vea asi
    // {
        //     especie: {...},
        //     personaje: {...}
    // }
